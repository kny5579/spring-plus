...
public class ManagerService {
    ...
    public ManagerSaveResponse saveManager(AuthUser authUser, long todoId, ManagerSaveRequest managerSaveRequest) {
        ...
        try {
            ...
            logService.saveLog(savedManagerUser.getId(), "Success to saveManager");
            ...
            logService.saveLog(managerSaveRequest.getManagerUserId(),"Failed to saveManager: "+e.getMessage());
            throw e;
        }
    }
